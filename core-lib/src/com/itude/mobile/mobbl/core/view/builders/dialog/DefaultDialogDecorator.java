...
public class DefaultDialogDecorator implements MBDialogDecorator
{

  @Override
  public void show(MBDialogController dialog)
  {
    MBViewManager.getInstance().setContentView(dialog.getMainContainer());
    MBViewManager.getInstance().setTitle(dialog.getTitle());
  }
