...
public final class MBProcesHelper
{
  public static boolean  _homeKeyPressed;
  private static boolean justLaunched = true;

  
  private MBProcesHelper()
  {
  }
  ...
  public static void checkJustLaunced()
  {
    if (justLaunched)
    {
      _homeKeyPressed = true;
      justLaunched = false;
    }
    else
    {
      _homeKeyPressed = false;
    }
  }
   ...
   * 
   * @see {@link MBProcesHelper.killApp}
   */
