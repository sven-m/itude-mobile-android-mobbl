...
import static com.itude.mobile.mobbl.core.services.MBLocalizationService.getLocalizedString;
...
public class MBRESTServiceDataHandler extends MBWebserviceDataHandler {
    ...
    protected String getHTTPRequestBody(MBDocument doc, String operationMethod) {
        String body = null;
        if (doc != null) {
    ...
    public MBDocument doLoadDocument(String documentName, MBDocument doc) {
        ...
        String body = getHTTPRequestBody(doc, operationMethod);

        MBLog.d(MBConstants.APPLICATION_NAME,
                "RestServiceDataHandler is send this message: \n" + body + "\n to " + endPoint.getEndPointUri() + " with operation: " + operationMethod);
    ...
    protected String postAndGetResult(MBEndPointDefinition endPoint, //
        ...
        HttpUriRequest httpUriRequest = setupHttpUriRequest(operationMethod, endPointUri, body);
    ...
    private HttpUriRequest setupHttpUriRequest(String operationName, String endPointUri, String body) throws UnsupportedEncodingException {
