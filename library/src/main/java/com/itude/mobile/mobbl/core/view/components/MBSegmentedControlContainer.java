...
import com.itude.mobile.mobbl.core.view.components.MBSegmentedControlBar.MBOnSelectedListener;
...
public class MBSegmentedControlContainer extends RelativeLayout implements MBOnSelectedListener {
    ...
    private MBSegmentedControlBar _controlBar;

    public MBSegmentedControlContainer(Context context) {
        super(context);
    ...
    public MBSegmentedControlContainer(Context context, AttributeSet attrs) {
        this(context);
    }
