...
import com.itude.mobile.mobbl.core.controller.util.MBDefaultHomeButtonHandler;
...
public abstract class MBViewManager extends ActionBarActivity implements MBDialogChangeListener {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        final String outcomeName = intent.getStringExtra(MBConstants.C_INTENT_POST_INITIALOUTCOMES_OUTCOMENAME);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (getActiveDialog() != null)
            for (MBBasicViewController controller : getActiveDialog().getAllFragments()) {
    ...
    public void showPage(MBPage page, String displayMode, boolean addToBackStack) {
        ...
        MBLog.d(MBConstants.APPLICATION_NAME, "MBViewManager: showPage name=" + page.getPageName() + " pagestackName=" + page.getPageStackName()
    ...
    private void showAlertView(MBPage page) {
        ...
        if (pageDoc.getName().equals(MBConfigurationDefinition.DOC_SYSTEM_EXCEPTION)) {
            ...
            try {
                ...
                MBLog.w(MBConstants.APPLICATION_NAME, "Popup document " + pageDoc.getName() + " has no buttons defined. Adding neutral button Ok");
            }
        }
    ...
    public void setOrientation(int orientation) {
        MBLog.d(MBConstants.APPLICATION_NAME, "MBViewManager.setOrientation: Changing to " + orientation);
        setRequestedOrientation(orientation);
    }

    public void setOrientation(MBPage page) {
        if (page == null) {
            MBLog.w(MBConstants.APPLICATION_NAME, "Can't set orientation without an MBPage");
            return;
        }
     ...
     */
        if (orientationPermissions == MBPage.OrientationPermission.UNDEFINED) {
            ...
            if (getRequestedOrientation() != ActivityInfo.SCREEN_ORIENTATION_SENSOR) {
                MBLog.d(MBConstants.APPLICATION_NAME, "MBViewManager.setOrientation: Changing to SENSOR");
                setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_SENSOR);
            }
        } else if (orientationPermissions == OrientationPermission.PORTRAIT) {
            MBLog.d(MBConstants.APPLICATION_NAME, "MBViewManager.setOrientation: Changing to PORTRAIT");
            setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        } else if (orientationPermissions == OrientationPermission.LANDSCAPE) {
            MBLog.d(MBConstants.APPLICATION_NAME, "MBViewManager.setOrientation: Changing to LANDSCAPE");
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        MBLog.d(MBConstants.APPLICATION_NAME, "MBViewManager.onConfigurationChanged");
